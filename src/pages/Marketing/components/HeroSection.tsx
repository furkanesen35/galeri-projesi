  ...
  return (
    <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="text-xl md:text-2xl text-text-secondary mb-8 max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '100ms' }}>
          {content?.subheadline}
        </p>
        ...
        {/* Trust indicator */}
        <p className="mt-8 text-sm text-text-muted animate-fade-in" style={{ animationDelay: '300ms' }}>
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-primary-300/10 rounded-full blur-3xl animate-pulse-soft" style={{ animationDelay: '1s' }}></div>
    </section>
  );
};
