...
const ankaufvertragFields: DocumentField[] = [
  ...
  {
    id: 'has_spare_key',
    label: 'Ersatzschlüssel vorhanden',
    type: 'checkbox',
    section: 'condition',
    width: 'third',
  },
  ...
  },
  {
    ...
    type: 'textarea',
    section: 'condition',
    placeholder: 'z.B. Winterreifen, Dachgepäckträger...',
    width: 'full',
  },
  ...
  {
    id: 'no_liens',
    label: 'Frei von Rechten Dritter',
    type: 'checkbox',
    section: 'legal',
    width: 'third',
  },
  {
    id: 'owner_confirms',
    label: 'Verkäufer ist Eigentümer',
    type: 'checkbox',
    section: 'legal',
    required: true,
    width: 'third',
...
const verkaufsvertragFields: DocumentField[] = [
  ...
  {
    id: 'additional_warranty',
    label: 'Zusatzgarantie',
    type: 'select',
    section: 'warranty',
    width: 'half',
    options: [
  ...
  // Sonstiges
  {
    ...
    label: 'Im Preis enthaltenes Zubehör',
    type: 'textarea',
    section: 'extras',
    width: 'full',
  },
...
const uebergabeprotokollFields: DocumentField[] = [
  ...
  {
    id: 'vehicle_mileage',
    label: 'Kilometerstand bei Übergabe',
    type: 'number',
    section: 'vehicle',
    required: true,
    width: 'half',
  ...
  {
    id: 'doc_fahrzeugbrief',
    label: 'Fahrzeugbrief (ZB II)',
    type: 'checkbox',
    section: 'documents',
    width: 'third',
  },
  {
    id: 'doc_fahrzeugschein',
    label: 'Fahrzeugschein (ZB I)',
    type: 'checkbox',
    section: 'documents',
    width: 'third',
  },
  ...
  {
    id: 'noted_damages',
    label: 'Dokumentierte Mängel/Schäden',
    type: 'textarea',
    section: 'condition',
    width: 'full',
  },
  ...
  {
    id: 'intro_controls',
    label: 'Bedienung erklärt',
    type: 'checkbox',
    section: 'introduction',
    width: 'third',
  },
  {
    id: 'intro_infotainment',
    label: 'Infotainment erklärt',
    type: 'checkbox',
    section: 'introduction',
    width: 'third',
  },
  {
    id: 'intro_safety',
    label: 'Sicherheitssysteme erklärt',
    type: 'checkbox',
    section: 'introduction',
    width: 'third',
  },
  {
    id: 'intro_notes',
    label: 'Anmerkungen zur Einweisung',
    type: 'textarea',
    section: 'introduction',
    width: 'full',
  },
  ...
  // Bestätigung
  {
    ...
    label: 'Kunde bestätigt ordnungsgemäße Übergabe',
    type: 'checkbox',
...
const probefahrtFields: DocumentField[] = [
  ...
  {
    id: 'accompanied',
    label: 'Begleitung durch Mitarbeiter',
    type: 'checkbox',
    section: 'details',
    width: 'half',
  },
  ...
  {
    id: 'insurance_note',
    label: 'Versicherungshinweis bestätigt',
    type: 'checkbox',
    section: 'insurance',
    required: true,
    width: 'full',
  ...
  {
    id: 'deductible',
    label: 'Selbstbeteiligung im Schadensfall (€)',
    type: 'currency',
    section: 'insurance',
    defaultValue: '500',
    width: 'half',
...
const datenschutzFields: DocumentField[] = [
  ...
  {
    id: 'consent_contact_email',
    label: 'Kontakt per E-Mail erlaubt',
    type: 'checkbox',
    section: 'consent',
    width: 'half',
  },
  {
    ...
    label: 'Newsletter-Zusendung erlaubt',
    type: 'checkbox',
    section: 'consent',
    width: 'half',
  },
  {
    id: 'consent_offers',
    label: 'Zusendung von Angeboten erlaubt',
    type: 'checkbox',
    section: 'consent',
    width: 'half',
  },
  {
    ...
    label: 'Datenspeicherung gemäß DSGVO bestätigt',
    type: 'checkbox',
    section: 'consent',
    required: true,
    width: 'full',
...
const werkstattauftragFields: DocumentField[] = [
  ...
  // Kostenvoranschlag
  {
    id: 'estimate_required',
    label: 'Kostenvoranschlag gewünscht',
    type: 'checkbox',
    section: 'estimate',
    width: 'half',
  },
  ...
  {
    id: 'additional_work_approval',
    label: 'Zusatzarbeiten bis (€) ohne Rücksprache',
    type: 'currency',
    section: 'estimate',
    width: 'half',
  },
  {
    id: 'call_before_work',
    label: 'Vor Arbeitsbeginn anrufen',
    type: 'checkbox',
    section: 'estimate',
    width: 'half',
  },
