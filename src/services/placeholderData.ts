...
export const salesContractData = {
  ...
  price: {
    ...
    vatAmount: Math.round(carForSale.targetPrice - carForSale.targetPrice / 1.19),
    paymentMethod: 'bank_transfer',
    downPayment: 5000,
    remainingAmount: carForSale.targetPrice - 5000,
    paymentDueDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // 7 days
  },
  ...
  handover: {
    ...
    accessories: ['Winterreifen auf Stahlfelgen (optional)', 'Original BMW Fußmatten'],
  },
