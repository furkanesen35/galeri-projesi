...
export const InlinePanelStyler: React.FC<InlinePanelStylerProps> = ({
  ...
  const [activeSection, setActiveSection] = useState<
    "quick" | "background" | "text" | "border" | "effects"
  >("quick");
        ...
        {activeSection === "text" && (
          <div className="space-y-3">
            ...
            <div className="pt-2 border-t border-border space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-text-secondary">
                    An alle Inhalte weitergeben
                  </p>
                </div>
                <button
                  onClick={() =>
                    onStyleChange({ inheritColors: !style?.inheritColors })
                  }
                  className={`
              ...
              <p className="text-xs text-text-secondary">
                💡 Aktivieren Sie dies, damit die Textfarbe auf alle Komponenten
                im Panel angewendet wird
              </p>
            </div>
          </div>
        )}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    onStyleChange({ borderWidth: parseInt(e.target.value) })
                  }
                  className="w-20 accent-primary"
                />
                <span className="text-xs text-foreground w-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    onStyleChange({ borderRadius: parseInt(e.target.value) })
                  }
                  className="w-20 accent-primary"
                />
                <span className="text-xs text-foreground w-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <select
                ...
                onChange={(e) =>
                  onStyleChange({
                    shadowSize: e.target.value as PanelStyle["shadowSize"],
                  })
                }
      ...
      <div className="p-3 border-t border-border bg-bg-secondary">
        ...
        >
          <div
            ...
            style={{
              color: style?.headerTextColor || style?.textColor || "inherit",
            }}
          >
            {panelTitle}
          </div>
