...
import { Palette, X, RotateCcw, Type, Square, Droplets, Sparkles } from 'lucide-react';
          ...
          <div className="space-y-3">
            ...
            <div className="pt-2 border-t border-border space-y-2">
              ...
              <p className="text-xs text-text-secondary">
                💡 Aktivieren Sie dies, damit die Textfarbe auf alle Komponenten im Panel angewendet
                wird
              </p>
            </div>
          </div>
